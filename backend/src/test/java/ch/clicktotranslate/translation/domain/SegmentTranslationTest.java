...
class SegmentTranslationTest {
	...
	private final class TestContext {
		...
		private final TextTranslation textTranslation = mock(TextTranslation.class);

		private final SegmentTranslation underTest = new SegmentTranslation(textTranslation);
		...
		private void stubTranslation(String text, String translatedText) {
			given(textTranslation.translate(argThat(request -> request != null && request.text().equals(text)
					&& request.sourceLanguage() == sourceLanguage && request.targetLanguage() == targetLanguage)))
