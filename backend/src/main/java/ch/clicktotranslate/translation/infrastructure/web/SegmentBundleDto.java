...
public record SegmentBundleDto(String userId, String word, String sentence, String sourceLanguage,
		String targetLanguage, SourceDto source, SourceMetadataDto sourceMetadata, Instant occurredAt) {
