...
public class VocabConfiguration {
	...
	@Bean
	public ListVocabulary listVocabulary(LemmaRepository lemmaRepository, UsageRepository usageRepository) {
	...
	@Bean
	public DeleteLemma deleteLemma(LemmaRepository lemmaRepository, UsageRepository usageRepository) {
		return new DeleteLemma(lemmaRepository, usageRepository);
	}

	@Bean
	public ClearVocabulary clearVocabulary(LemmaRepository lemmaRepository, UsageRepository usageRepository) {
		return new ClearVocabulary(lemmaRepository, usageRepository);
	}

	@Bean
	public ExportVocabulary exportVocabulary(LemmaRepository lemmaRepository, UsageRepository usageRepository) {
	...
	@Bean
	public TranslatedWordEventHandler translatedWordEventHandler(
	...
	public ClickToTranslateTranslationServiceApiClient clickToTranslateTranslationServiceApiClient() {
		return new SpringTranslationApiClient();
	}

	@Bean
	public TranslationGateway translationGateway(ClickToTranslateTranslationServiceApiClient apiClient,
	...
	public VocabHttpController vocabHttpController(VocabController vocabController,
			HttpListVocabularyRequestMapper listRequestMapper, HttpUpdateLemmaRequestMapper updateRequestMapper,
		...
		return new VocabHttpController(vocabController, listRequestMapper, updateRequestMapper, deleteRequestMapper,
				clearRequestMapper, resolveTempRefRequestMapper, resolveTempRefResponseMapper,
				addWordManuallyRequestMapper, addWordManuallyResponseMapper);
	}
