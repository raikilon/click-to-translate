...
export class EntryDetailsPageComponent {
  ...
  private readonly translationSaveActions = new Map<string, (value: string) => Promise<void>>();
  ...
  applyEditorValue(event: Event, setValue: EditableFieldEditorContext['setValue']): void {
